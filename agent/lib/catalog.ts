...
const SKIS: {
  ...
  { brand: "Rossignol", model: "Experience 78", level: "beginner", style: "piste", lengths: [144, 152, 160, 166] },
  { brand: "Atomic", model: "Cloud Q8", level: "beginner", style: "piste", lengths: [147, 154, 161] },
  { brand: "Salomon", model: "S/Force 9", level: "intermediate", style: "piste", lengths: [155, 162, 168, 175] },
  { brand: "Head", model: "Kore 87", level: "intermediate", style: "all_mountain", lengths: [156, 163, 170, 177] },
  { brand: "Volkl", model: "Deacon 84", level: "advanced", style: "piste", lengths: [161, 168, 175, 182] },
  { brand: "Blizzard", model: "Rustler 10", level: "advanced", style: "all_mountain", lengths: [164, 172, 180, 188] },
  { brand: "Faction", model: "Dictator 3.0", level: "expert", style: "freeride", lengths: [172, 180, 186] },
  { brand: "Black Crows", model: "Corvus", level: "expert", style: "freeride", lengths: [178, 183, 188] },
];

const BOOTS = [
  { brand: "Nordica", model: "Speedmachine 3 85", flex: 85, level: "intermediate" as Level },
  { brand: "Lange", model: "RX 110", flex: 110, level: "advanced" as Level },
  { brand: "Atomic", model: "Hawx Prime 70", flex: 70, level: "beginner" as Level },
];
...
export function rateFor(category: Category, level: Level | undefined, days: number) {
  const candidates = rates
    .filter((rate) => rate.category === category && rate.minDays <= days)
    .filter((rate) => (level ? rate.level === level || rate.level === null : true))
...
export function isBusy(id: string, startDate: string, endDate: string): boolean {
...
export const knowledge = [
  { title: "Orari e sedi", section: "Informazioni generali", content: "Il negozio di Canazei e' aperto tutti i giorni dalle 8:00 alle 19:00 durante la stagione (dicembre-aprile). Il punto di ritiro a Campitello apre alle 8:30 e chiude alle 18:00." },
  { title: "Ritiro dell'attrezzatura", section: "Noleggio", content: "Il ritiro avviene in negozio con un documento e il codice della prenotazione. Chi ritira dopo le 16:00 non paga quel giorno: il conteggio parte dal mattino successivo." },
  { title: "Restituzione e ritardi", section: "Noleggio", content: "L'attrezzatura va restituita entro la chiusura dell'ultimo giorno. Il ritardo si conteggia a giorno intero, non a ore. Se dipende da un impianto chiuso non viene addebitato." },
  { title: "Cauzione", section: "Noleggio", content: "La cauzione e' un'autorizzazione sulla carta, non un addebito, e viene rilasciata alla riconsegna: 150 euro per gli sci base, fino a 400 per il freeride, 100 per gli scarponi. Non si accettano contanti." },
  { title: "Assicurazione", section: "Noleggio", content: "Facoltativa, si aggiunge al prezzo giornaliero. Copre rottura e furto con denuncia. Non copre lo smarrimento ne' l'uso improprio. Si sottoscrive alla prenotazione, non dopo il ritiro." },
  { title: "Cancellazione e modifiche", section: "Policy", content: "Cancellazione gratuita fino a 48 ore prima. Fra 48 e 24 ore si trattiene il 30 per cento. Nelle ultime 24 ore l'importo e' dovuto per intero. Le modifiche di data sono gratuite se c'e' disponibilita'. Chiusura impianti per mancanza di neve: rimborso totale." },
  { title: "Pagamenti", section: "Policy", content: "Si paga al ritiro, in negozio: carte, bancomat, contanti fino a 999 euro. La prenotazione online non richiede pagamento anticipato." },
  { title: "Attrezzatura per bambini", section: "Noleggio", content: "Fino a dodici anni sci, scarponi, bastoncini e casco a 15 euro al giorno. Il casco per i minori e' obbligatorio per legge ed e' compreso." },
  { title: "Manutenzione", section: "Servizi", content: "Sciolinatura e affilatura sono comprese nel noleggio e si fanno ogni sera. Per l'attrezzatura di proprieta' il servizio costa 25 euro." },
  { title: "Come si scelgono le misure", section: "Consulenza", content: "La lunghezza degli sci dipende da altezza, peso, livello e stile, non dalla sola altezza. Gli scarponi si misurano in mondopoint, che non coincide col numero di scarpa. I bastoncini si prendono al 68 per cento dell'altezza." },
];
